...
public class Leg : MonoBehaviour
{
    ...
    public void TryMove()
    {
        ...
        if (FindBestSurface(out RaycastHit hit))
        {
            ...
            // Si hay un cambio grande de superficie, forzamos el paso aunque est� cerca
    ...
    private bool FindBestSurface(out RaycastHit bestHit)
    {
        ...
        //(Vector3.down + _body.forward * 0.5f).normalized,   //directo hacia abajo en world space con m�s alcance
        ...
        foreach (var dir in directions)
        {
                ...
                castDist, _surface, QueryTriggerInteraction.Ignore))
            {
                ...
                // Score: priorizamos la m�s cercana y la que va en la direcci�n de movimiento
    ...
    public void TrySettle()
    {
        ...
        if (FindBestSurface(out RaycastHit hit))
        {
            ...
            // Umbral m�s peque�o para que se acomode bien al detenerse
