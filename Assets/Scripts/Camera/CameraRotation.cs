...
public class CameraRotation : MonoBehaviour
{
    ...
    {
        // Posici�n deseada: detr�s y arriba del personaje seg�n su orientaci�n
    ...
    {
        Vector3 targetUp = _pjC.CurrentUp; // expon� _currentUp como propiedad

        // Interpolamos el up de la c�mara lentamente
